...
public class ConsoleColors {
    ...
    // Bold
    protected static final String BLACK_BOLD = "\033[1;30m";  // BLACK
    ...
    protected static final String WHITE_BOLD = "\033[1;37m";  // WHITE

    // Underline
    protected static final String BLACK_UNDERLINED = "\033[4;30m";  // BLACK
    ...
    protected static final String CYAN_UNDERLINED = "\033[4;36m";   // CYAN
    protected static final String WHITE_UNDERLINED = "\033[4;37m";  // WHITE

    // Background
    protected static final String BLACK_BACKGROUND = "\033[40m";  // BLACK
    ...
    protected static final String CYAN_BACKGROUND = "\033[46m";   // CYAN
    protected static final String WHITE_BACKGROUND = "\033[47m";  // WHITE

    // High Intensity
    protected static final String BLACK_BRIGHT = "\033[0;90m";  // BLACK
    ...
    protected static final String CYAN_BRIGHT = "\033[0;96m";   // CYAN
    protected static final String WHITE_BRIGHT = "\033[0;97m";  // WHITE
    ...
    protected static final String BLACK_BACKGROUND_BRIGHT = "\033[0;100m";// BLACK
    ...
    protected static final String CYAN_BACKGROUND_BRIGHT = "\033[0;106m";  // CYAN
    protected static final String WHITE_BACKGROUND_BRIGHT = "\033[0;107m";   // WHITE
}